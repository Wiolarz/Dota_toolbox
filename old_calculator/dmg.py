...
#s 19 - 118 3.4 na lvl
#z 19 - 77 2.0 na lvl
#lvl wbijaja staty maksymalnie 29 razy
...
#nie ma spell ampu, i nic z życia  i nic z golda
#nie ma efektow
#jestarmlet
#nie ma necro i dagona
itemy = [{"value": 25, "type": "int"},  #mystic staff
         ...
         {"value": 15, "type": "dmg", "value2": 12, "type2": "str", "value3": 10, "type3": "int", "value4": 10, "type4": "spd"},  # echo sabre
         ...
         {"value": 45, "type": "dmg", "value2": 30, "type2": "spd", "value3": 15, "type3": "str", "value4": 15, "type4": "zr", "value5": 15, "type5": "int"}, #silver edge
         {"value": 10, "type": "str", "value2": 25, "type2": "dmg"}, #abysal
         {"value": 25, "type": "int", "value2": 85, "type2": "spd", "value3": 30, "type3": "dmg"}, # bloddthorn
         {"value": 55, "type": "spd", "value2": 5, "type2": "str", "value3": 5, "type3": "zr", "value4": 5, "type4": "armour"},  #assault
         {"value": 45, "type": "str"},  #hart
         {"value": 12, "type": "spd", "value2": 10, "type2": "str", "value3": 26, "type3": "zr", "value4": 10, "type4": "int"},  #manta
         ...
         {"value": 25, "type": "dmg", "value2": 25, "type2": "str"},  # satanic
         {"value": 10, "type": "str", "value2": 10, "type2": "zr", "value3": 10, "type3": "int", "value4": 8, "type4": "armour"},  # solarcrest
...
itemyyyyy = [{"value": 25, "type": "int"},  #mystic staff
         ...
         {"value": 10, "type": "str", "value2": 25, "type2": "dmg"}, #abysal
         {"value": 25, "type": "int", "value2": 85, "type2": "spd", "value3": 30, "type3": "dmg"}, # bloddthorn
         {"value": 30, "type": "spd", "value2": 5, "type2": "str", "value3": 5, "type3": "zr", "value4": 5, "type4": "int"},  #assault
         {"value": 45, "type": "str"},  #hart
         {"value": 12, "type": "spd", "value2": 10, "type2": "str", "value3": 26, "type3": "zr", "value4": 10, "type4": "int"},  #manta
...
#szukanie najwiekszego dps
maxdps = 0
#szukanie najmniejszego dps
mindps = 1000
...
while True:
    ...
    if mindps > d:
        mindps = d
        minz = tuple(z)
    if licznik % 500000 == 0:    # z[0] == 0 and z[1] == 0:
        print("\r%2d %2d %2d %2d %2d %2d = min %7.2f" % (minz[0], minz[1], minz[2], minz[3], minz[4], minz[5], mindps), end='')
        print("  %2d %2d %2d %2d %2d %2d = cur %7.2f" % (z[0], z[1], z[2], z[3], z[4], z[5], d), end='')
        print("  %2d %2d %2d %2d %2d %2d = max %7.2f" % (maxz[0], maxz[1], maxz[2], maxz[3], maxz[4], maxz[5], maxdps), end='')
    licznik += 1
...
print("\n", "min dps:", mindps,"max dps:", maxdps, "   koniec")
